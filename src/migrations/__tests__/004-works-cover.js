...
import { up, down } from '../004-works-cover';

describe('#up', () => {
  it('creates works_covers table', () => {
    ...
    expect(call[0]).toBe('works_covers');
  });
...
describe('#down', () => {
  it('drops works_covers table', () => {
    const queryInterface = createQueryInterfaceMock(jest.fn);
    down(queryInterface, Sequelize);
    expect(queryInterface.dropTable).toBeCalledWith('works_covers');
  });
});
